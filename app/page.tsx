...
const basePath = '/luminos-studio-1778133098524';
...
export default function Home() {
  ...
  const submit = (e: any) => {
    ...
    window.open(`https://wa.me/60145678901?text=${msg}`, '_blank');
  };
  ...
  const products = [{ n: 'Residential Design', d: 'Full home interior concept and execution', i: 'https://images.pexels.com/photos/8583536/pexels-photo-8583536.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'domain' }, { n: 'Commercial Design', d: 'Office and retail space transformation', i: 'https://images.pexels.com/photos/5483245/pexels-photo-5483245.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'architecture' }, { n: '3D Visualization', d: 'Photorealistic renders before construction begins', i: 'https://images.pexels.com/photos/29808917/pexels-photo-29808917.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'chair' }, { n: 'Renovation Consulting', d: 'Expert advice on materials and layout', i: 'https://images.pexels.com/photos/15798782/pexels-photo-15798782.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'eco' }, { n: 'Furniture Sourcing', d: 'Curated pieces from local and international suppliers', i: 'https://images.pexels.com/photos/6969830/pexels-photo-6969830.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'precision_manufacturing' }];
    ...
    <div className="min-h-screen bg-surface text-on-surface font-body selection:bg-accent/30 selection:text-primary">
      ...
      <nav className="fixed top-0 w-full z-50 bg-white/80 backdrop-blur-xl shadow-sm">
        <div className="flex justify-between items-center w-full px-8 py-4 max-w-7xl mx-auto">
          <div className="flex items-center gap-3">
            <span className="text-2xl font-black tracking-tighter text-primary font-headline">Luminos Studio</span>
          </div>
      ...
      <section id="home" className="relative h-screen flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0 z-0">
          <img src="https://images.pexels.com/photos/35203561/pexels-photo-35203561.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940" alt="Hero" className="w-full h-full object-cover" />
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-8 w-full">
          <div className="max-w-3xl">
            ...
            <p className="text-white/80 text-lg md:text-xl max-w-xl mb-10 leading-relaxed font-light">
              Luminos Studio delivers visionary solutions through sustainable design and uncompromising excellence.
            </p>
            <a
              href={`https://wa.me/60145678901`}
              target="_blank"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
            <div className="lg:col-span-5 space-y-8">
              ...
              <p className="text-on-surface-variant text-lg leading-relaxed">
                At Luminos Studio, we are dedicated to crafting bespoke spaces that reflect our clients\' unique stories and styles. With a passionate team of designers and experts, we strive to deliver holistic design solutions that balance beauty, function, and sustainability. By combining meticulous attention to detail with a deep understanding of our clients\' needs, we bring their vision to life.
              </p>
              {/* 4 Pillars Grid */}
              <div className="grid grid-cols-2 gap-8 pt-8">
                <div className="space-y-2">
                  <h4 className="font-headline font-bold text-primary">Vision</h4>
                  <p className="text-sm text-on-surface-variant">To be the leading design studio in creating inspirational and functional spaces that enrich the lives of our clients and communities.</p>
                </div>
                <div className="space-y-2">
                  <h4 className="font-headline font-bold text-primary">Mission</h4>
                  <p className="text-sm text-on-surface-variant">To provide exceptional design services that exceed our clients\' expectations, fostering long-term relationships built on trust, craftsmanship, and a passion for creating harmonious and meaningful environments.</p>
                </div>
                <div className="space-y-2">
                  <h4 className="font-headline font-bold text-primary">Craftsmanship</h4>
                  <p className="text-sm text-on-surface-variant">Every detail considered, nothing overlooked.</p>
                </div>
                <div className="space-y-2">
                  <h4 className="font-headline font-bold text-primary">Harmony</h4>
                  <p className="text-sm text-on-surface-variant">Design that balances beauty and function.</p>
                </div>
              </div>
            </div>
            ...
            <div className="lg:col-span-7 grid grid-cols-12 grid-rows-6 gap-4 h-[600px]">
              <div className="col-span-8 row-span-4 overflow-hidden rounded-xl">
                <img src="https://images.pexels.com/photos/5393593/pexels-photo-5393593.jpeg?auto=compress&cs=tinysrgb&h=650&w=940" alt="About 1" className="w-full h-full object-cover" />
              </div>
              <div className="col-span-4 row-span-3 overflow-hidden rounded-xl bg-surface-container">
                <img src="https://images.pexels.com/photos/8279799/pexels-photo-8279799.jpeg?auto=compress&cs=tinysrgb&h=650&w=940" alt="About 2" className="w-full h-full object-cover" />
              </div>
              <div className="col-span-5 row-span-2 overflow-hidden rounded-xl mt-4">
                <img src="https://images.pexels.com/photos/4623115/pexels-photo-4623115.jpeg?auto=compress&cs=tinysrgb&h=650&w=940" alt="About 3" className="w-full h-full object-cover" />
              </div>
            </div>
          </div>
        </div>
              ...
              <div className="space-y-12">
                ...
                <div className="flex gap-6">
                  ...
                  <div>
                    ...
                    <p className="text-white/60 text-sm">hello@luminosstudio.com</p>
                  </div>
                </div>
                <div className="flex gap-6">
                  ...
                  <div>
                    ...
                    <p className="text-white/60 text-sm">60145678901</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <footer className="bg-primary w-full py-12 px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-7xl mx-auto items-center text-center md:text-left">
          <div>
            <div className="text-xl font-bold text-white mb-4">Luminos Studio</div>
            <p className="text-white/60 text-sm leading-relaxed">Spaces that tell your story.</p>
          </div>
          <div className="flex justify-center md:justify-center gap-6">
            
            
            <a href={`https://wa.me/60145678901`} target="_blank" rel="noopener noreferrer" className="text-white/60 hover:text-white transition-colors text-sm">WhatsApp</a>
          </div>
          <div className="md:text-right">
            <p className="text-white/60 text-sm leading-relaxed">
              © {new Date().getFullYear()} Luminos Studio. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
